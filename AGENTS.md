...
- `apps/desktop`: the private Windows-first Electron/React Kimi Code Desktop application. Its sandboxed renderer talks only to the public Node SDK through validated IPC owned by the Electron main process.
