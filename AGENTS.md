...
- `apps/desktop`: the private cross-platform Electron/React Kimi Code Desktop application, released for Windows x64, macOS arm64, and Linux x64. Its sandboxed renderer talks only to the public Node SDK through validated IPC owned by the Electron main process.
