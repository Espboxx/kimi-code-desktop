...
export const slowToolStdioFixture = fileURLToPath(new URL(
  './fixtures/slow-tool-stdio-server.mjs',
  import.meta.url,
));
export const hangingListStdioFixture = fileURLToPath(new URL(
  './fixtures/hanging-list-stdio-server.mjs',
  import.meta.url,
));
export const crashAfterConnectFixture = fileURLToPath(new URL(
  './fixtures/crash-after-connect-stdio-server.mjs',
  import.meta.url,
));
export const stderrThenExitFixture = fileURLToPath(new URL(
